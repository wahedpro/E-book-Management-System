...
<body>
  ...
  <div class="card" style="width:400px">
    <img class="card-img-top" src="../images/Jhangar.jpg" alt="Card image" style="width:100%">
    <div class="card-body">
      <h4 class="card-title">Wahedul Islam</h4>
      <p class="card-text">Id: 2104010202248</p>
      <p class="card-text">4 Semester</p></p>
